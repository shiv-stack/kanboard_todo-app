...
function Home() {
  ...
  useEffect(() => {
    const fetchtodos = async () => {
      try {
        setLoading(true);
        const response = await axios.get("https://kanboard-todo-app-backend.vercel.app/todo/fetch", {
  ...
  const todoCreate = async () => {
    ...
    try {
      const response = await axios.post(
        "https://kanboard-todo-app-backend.vercel.app/todo/create",
        {
          text: newTodo,
          completed: false,
        },
  ...
  const todoStatus = async (id) => {
    ...
    try {
      const response = await axios.put(
        `https://kanboard-todo-app-backend.vercel.app/todo/update/${id}`,
        {
          ...todo,
  ...
  const todoDelete = async (id) => {
    try {
      await axios.delete(`https://kanboard-todo-app-backend.vercel.app/todo/delete/${id}`, {
        withCredentials: true,
      });
  ...
  const logout = async () => {
    try {
      await axios.get("https://kanboard-todo-app-backend.vercel.app/user/logout", {
        withCredentials: true,
      });
